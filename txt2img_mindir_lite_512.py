...
def postprocess(images, save_path, output_mode):
    ...
    save_path_file = os.path.join(save_path, "youshu_test_512_512.png")
    print("save_path: =================================================")
...
def load_model(mindir_path, context, output_mode):
    ...
    model_path_4 = os.path.join(mindir_path, "0719_out/out_wukong_youhua_512_512_graph_graph.mindir")
